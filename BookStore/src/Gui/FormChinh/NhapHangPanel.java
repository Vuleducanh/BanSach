...
public void loadNhanVien(NHANVIEN nvDM){
    ...
    private void loadNhaCungCap() {
        try {
            ...
            nxb.danhsachNHAXUATBAN(tempComboBox); 

            DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) tempComboBox.getModel(); // Lấy model từ JComboBox tạm thời
            NCC.setModel(model); 
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        NCC = new JComboBox<>(); // Initialize the JComboBox
        NCC.setEditable(false); // Prevent direct editing if needed
        NCC.setBackground(new java.awt.Color(204, 255, 204)); // Set background color
        NCC.setFont(new java.awt.Font("Segoe UI", 1, 12)); // Set font 
        NCC.setForeground(new java.awt.Color(0, 51, 51)); // Set foreground color
        ...
        Nhaptb.setBackground(new Color(204, 255, 204));
        Nhaptb.setForeground(new Color(0, 51, 51));
        Nhaptb.setFont(new Font("Times New Roman", Font.PLAIN, 14));
        ...
        Nhaptb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Sách", "Tên Sách", "Đơn giá", "Nhà Xuất Bản", "Số lần tái bản" // Thêm cột "Số lần tái bản"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.String.class, java.lang.Integer.class // Thêm kiểu dữ liệu cho cột mới
            };
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false
            };
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        if(status==1 && dataModel.getRowCount()>0){
            ...
            String nhaCungCap = (String) NCC.getSelectedItem();
            PHIEUNHAP t = new PHIEUNHAP(nv.getManv(), nhaCungCap, tongtien, sqlDate);
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
